...
const WorkerDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (!token) {
      ...
      console.log('Attempting to fetch token again...');
      // Try to get token from props or context
      setTimeout(() => {
        const retryToken = getAuthToken();
        if (retryToken) {
          console.log('✅ Token found on retry, refreshing page...');
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-8">
        ...
        <div className="mb-6">
          ...
          {isConnected && socketId && (
            <p className="text-xs text-green-600 mt-1">✅ Real-time connection active • Ready to receive bookings</p>
          )}
        </div>
